...
onSubmit=()=>{
    ...
    search=(e)=> {
     ...
     render(){
        ...
        <button className="nav nav-pills" onClick={this.onSubmit}   style={{fontFamily: "'Cinzel' , serif",backgroundColor:"#1C1854",color:"white",width:"170px",fontWeight:"100",fontSize:"30px"}}>Lifestyle<i className="fas fa-tshirt" style={{fontSize:"20px",color:"red"}} ></i></button>
                {this.state.bring ? (
